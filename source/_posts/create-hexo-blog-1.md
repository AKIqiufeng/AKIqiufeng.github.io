...
tags:
  - 博客搭建
cover: https://r2.aki1205.top/imghost/2024/07/v2-7827197bfa0023932d428633d41372fd_180x120.jpg
single_column: true
---
...
![image.png](https://r2.aki1205.top/imghost/2024/07/202407021639742.png)

**2.点击下载链接**
![image.png](https://r2.aki1205.top/imghost/2024/07/202407021622169.png)

**3.一路next，默认安装即可。**
![image.png](https://r2.aki1205.top/imghost/2024/07/202407021642812.png)
...
![image.png](https://r2.aki1205.top/imghost/2024/07/202407081546569.png)

**2.运行安装程序，点击Next，接受协议，然后点击Next。**
![image.png](https://r2.aki1205.top/imghost/2024/07/202407081547418.png)
![image.png](https://r2.aki1205.top/imghost/2024/07/202407081553630.png)

**3.选择安装路径，可以自己在其他盘创建一个文件夹（路径最好是全英文），然后点击next**
![image.png](https://r2.aki1205.top/imghost/2024/07/202407081555048.png)

**4.这里一定要选择Add to Path，随后点击Next，默认安装即可**。
![image.png](https://r2.aki1205.top/imghost/2024/07/202407081625859.png)

**5.验证Node.js**
我们可以在任意路径下点击鼠标右键，选择Open Git Bash here，打开Git的终端。
![image.png](https://r2.aki1205.top/imghost/2024/07/202407081602305.png)
然后在终端里输入以下指令：
```Bash
node -v
npm -v
...
![image.png](https://r2.aki1205.top/imghost/2024/07/202407081621788.png)
...
```
能够输出版本号就说明安装成功。
![image.png](https://r2.aki1205.top/imghost/2024/07/202407111641835.png)
...
hexo init
```
![image.png](https://r2.aki1205.top/imghost/2024/07/202407111652163.png)
...
hexo s
```
![image.png](https://r2.aki1205.top/imghost/2024/07/202407222326422.png)
![image.png](https://r2.aki1205.top/imghost/2024/07/202407222326980.png)
...
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231215039.png)
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231218363.png)
...
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231236448.png)
点击右边绿色的New SSH key按钮，填写密钥信息，最后点击Add SSH key，即可添加密钥
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231240817.png)
执行以下命令，可以查看设置是否成功。
```bash
...
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231315058.png)
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231320079.png)
...
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231333887.png)
...
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231342301.png)
2.添加完解析记录后，回到Github pages的设置页面，在Custom domain上填写自己的域名，也可以勾选下方强制使用HTTPS，增加网站的安全性。
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231344884.png)
3.最后等待配置完成，完成后，设置的上面域名变成自己的域名，就代表配置成功了。
![image.png](https://r2.aki1205.top/imghost/2024/07/202407231347983.png)
...
敬请期待我的下一篇博客搭建教程。
![1.png](https://r2.aki1205.top/imghost/2024/07/1.png)
